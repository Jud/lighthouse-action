...
# Run Lighthouse!
URL="${REPORT_URL}" BASE_URL="${BASE_REPORT_URL}" BASE_REPORT_PATH="${BASE_OUTPUT_PATH}" REPORT_PATH="${OUTPUT_PATH}" NETLIFY_BASE_AUTH="${INPUT_NETLIFY_BASE_PASSWORD}" NETLIFY_AUTH="${INPUT_NETLIFY_PASSWORD}" node /app/lighthouse.js
